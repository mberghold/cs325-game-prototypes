...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.image('outone', 'assets/EmptyHouse1.png');
            game.load.image('outtwo', 'assets/EmptyHouse2.png');
            game.load.image('outthree', 'assets/EmptyHouse3.png');
            game.load.image('outfour', 'assets/EmptyHouse4.png');
            game.load.image('outfive', 'assets/EmptyHouse5.png');
            game.load.image('outsix', 'assets/EmptyHouse6.png');
            game.load.image('outseven', 'assets/EmptyHouse7.png');
            game.load.image('outeight', 'assets/EmptyHouse8.png');
            game.load.image('outnine', 'assets/EmptyHouse9.png');
